...
update utilisateur set login = concat(login,'2'), email = CONCAT(login,"@swiss-galaxy.com") where id in ('a286e', 'g696e' , 'h414e', 'l945e','m127e', 'r115z',  'a37n') ;
...
insert into utilisateur(id, nom, prenom, login, mdp, adresse, cp, ville, dateembauche, role, email)
